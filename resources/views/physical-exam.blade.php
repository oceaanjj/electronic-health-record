                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="alert-box">
                            ...
                            <!-- session('cdss.general_appearance') -->
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea name="skin_condition" class="notepad-lines" placeholder="Enter SKIN findings">{{ old('skin_condition', $physicalExam->skin_condition ?? '') }}
                                                    </textarea>
                        </td>
                        <td class="alert-box">
