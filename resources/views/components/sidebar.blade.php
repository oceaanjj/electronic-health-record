<div id="mySidenav"
    ...
    <ul class="mt-[140px] text-dark-green text-[13px] font-creato-black pr-[10px] pl-[10px]">
        <li>
            <a href="{{ route('nurse-home') }}" class="group flex items-center gap-3 pl-4 pb-2 pt-2
    ...
    : 'hover:bg-hover hover:font-bold' }}">
        ...
        <li>
            <a href="{{ route('diagnostics.index') }}" class="group flex items-center gap-3 pl-5 pb-2 pt-2 
                        hover:bg-dark-green transition-all duration-200 rounded-l-[10px] rounded-r-[10px]
                         {{ request()->routeIs('diagnostics.index')
    ? 'bg-dark-green text-white font-bold'
    : 'hover:bg-hover hover:font-bold' }}">
                <img src="./img/sidebar/diagnostics.png" alt="Lab Icon" class="w-5 h-5 transition duration-200">
                <span
                    class="{{ request()->routeIs('diagnostics.index') ? 'text-white font-bold' : 'group-hover:font-bold' }}">Diagnostics</span>
            </a>
        </li>
