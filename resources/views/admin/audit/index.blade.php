...
@section('content')
    ...
    <div class="mx-auto my-12 w-full px-4 md:w-[90%] md:px-0 lg:w-[85%]">
        ...
        <div class="mb-10 flex flex-col items-center justify-between gap-6 lg:flex-row">
            ...
            {{-- Sort Buttons --}}
            <div
                class="flex w-full flex-wrap items-center justify-center gap-3 text-gray-700 lg:mr-10 lg:w-auto lg:justify-end"
            >
        ...
        <div class="overflow-hidden rounded-[20px] border border-gray-100 shadow-2xl">
            <div class="main-header bg-white py-4 font-bold tracking-wider">
                {{-- Added bg-white to ensure header background --}}
                    ...
                    <tbody id="audit-table-body" class="divide-y divide-gray-200 text-sm text-gray-700">
                        @forelse ($logs as $log)
                            ...
                            <tr class="transition duration-300 hover:bg-gray-50">
                                ...
                                <td class="min-w-[250px] px-4 py-3 text-[13px] text-gray-700 md:min-w-0">
                                    @if ($details)
                                        @if (is_array($details))
                                            ...
                                            <div class="space-y-1">
                                                @foreach ($details as $key => $value)
                                                    @if ($key !== 'details' && $key !== 'user_role')
                                                        <div
                                                            class="flex flex-wrap text-left text-[13px] leading-relaxed"
                                                        >
        ...
        {{-- BOTTOM ACTIONS --}}
        <div class="mt-12 flex w-full flex-col items-center pb-20">
            {{-- Pagination Wrapper --}}
            <div class="custom-pagination mb-8 flex w-full flex-col items-center justify-center">
