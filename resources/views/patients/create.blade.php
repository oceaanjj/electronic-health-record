            ...
            <div class="shadow-2xl rounded-xl overflow-hidden mb-10 border border-gray-100">
                ...
                <div class="bg-white p-6 sm:p-8">
                    <div class="grid grid-cols-1 md:grid-cols-6 gap-6">
                        ...
                        {{-- Birthdate --}}
                        <div class="col-span-6 md:col-span-2">
                            <label for="birthdate" class="block text-sm font-semibold text-gray-700 mb-1">Birthdate <span class="text-red-500">*</span></label>
                        ...
                        <div class="col-span-6 md:col-span-3">
                            <label for="sex" class="block text-sm font-semibold text-gray-700 mb-1">Sex <span class="text-red-500">*</span></label>
                        ...
                        {{-- Birth Place --}}
                        <div class="col-span-6 md:col-span-2">
                            <label for="birthplace" class="block text-sm font-semibold text-gray-700 mb-1">Birth Place</label>
                        ...
                        {{-- Chief Complaints --}}
                        <div class="col-span-6">
                            <label for="chief_complaints" class="block text-sm font-semibold text-gray-700 mb-1">Chief of Complaints</label>
                        ...
                        {{-- Admission Info --}}
                        <div class="col-span-6 md:col-span-2">
                            <label for="admission_date" class="block text-sm font-semibold text-gray-700 mb-1">Admission Date</label>
            ...
            <div class="shadow-2xl rounded-xl overflow-hidden mb-10 border border-gray-100">
                ...
                <div class="bg-white p-6 sm:p-8">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            <label for="contact_relationship" class="block text-sm font-semibold text-gray-700 mb-1">Relationship</label>
                            <input type="text" id="contact_relationship" name="contact_relationship" value="{{ old('contact_relationship') }}"
                                class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg shadow-sm 
                                focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out placeholder-gray-400"
                                placeholder="e.g. Spouse, Parent">
                        </div>
                        <div>
                            <label for="contact_number" class="block text-sm font-semibold text-gray-700 mb-1">Contact Number</label>
