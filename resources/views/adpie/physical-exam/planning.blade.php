...
@section('content')
    <style>
        ...
        /* Progress percentages for 4 steps */
    ...
    {{-- Progress Stepper --}}
    @php
        $currentStep = $step ?? 2; // Get step from controller, default to 2
    @endphp
        ...
        <fieldset>
                ...
                <div class="w-full overflow-hidden rounded-[15px] shadow-md">
                    ...
                    <div class="relative bg-beige">
                        <textarea
                            ...
                            placeholder="Enter planning (e.g., goals, outcomes)..."
                            maxlength="2000"
            ...
            <div class="mx-auto mt-8 mb-12 flex w-[70%] items-center justify-between">
                <div class="flex flex-col items-start">
                    <a href="{{ route('nursing-diagnosis.start', ['component' => $component, 'id' => $diagnosis->physical_exam_id]) }}" class="button-default text-center">
                        GO BACK
                    </a>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            textarea.addEventListener('input', function() {
                ...
                saveTimeout = setTimeout(function() {
                    ...
                    if (patientId) {
                        localStorage.setItem(`planning_draft_${patientId}`, textarea.value);
                    }
                }, 1500);
            });
            ...
            const patientId = '{{ $patient->patient_id ?? "" }}';
            if (patientId) {
                const draft = localStorage.getItem(`planning_draft_${patientId}`);
            ...
            document.querySelector('form').addEventListener('submit', function() {
                if (patientId) {
                    localStorage.removeItem(`planning_draft_${patientId}`);
                }
            });
