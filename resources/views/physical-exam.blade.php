    ...
    <div id="form-content-container">
        ...
        <form action="{{ route('physical-exam.store') }}" method="POST" class="cdss-form relative w-[70%] mx-auto"
            ...
            <fieldset @if (!session('selected_patient_id')) disabled @endif>
                ...
                {{-- CONTENT CONTAINER (Set to w-full because the Form controls the width now) --}}
                <div class="w-full flex justify-center items-start gap-0 mt-6">

                    {{-- LEFT SIDE: EXAM TABLES --}}
