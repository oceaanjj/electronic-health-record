        ...
        <div class="mx-auto mt-1 w-full">
            ...
            @if (session('selected_patient_id') && isset($labValue))
                <div id="cdss-alert-wrapper" class="w-full px-5 overflow-hidden transition-all duration-500">
                    ...
                    <div id="cdss-alert-content" class="relative flex items-center justify-between mt-3 py-3 px-5 border border-amber-400/50 rounded-lg shadow-sm bg-amber-100/70 backdrop-blur-md 
                                        animate-alert-in">
                                ...
                                <table class="w-full table-fixed border-collapse border-spacing-y-0 responsive-table">
                                    ...
                                    @foreach ($labTests as $label => $name)
                                        <tr class="border-b-2 border-line-brown/70 responsive-table-data-row">
                                            <td
                                                class="p-2 font-semibold bg-yellow-light text-brown text-center responsive-table-data responsive-table-data-label">
                                                {{ $label }}
                                            </td>
                                            ...
                                            <td class="p-2 bg-beige text-center responsive-table-data"
                                                data-label="NORMAL RANGE">
    ...
    ========================= */
                @media screen and (max-width: 640px) {
                    ...
                    .responsive-table-data {
                        ...
                        border-bottom: none;
                        position: relative;
                        /* Needed for data-label pseudo-element */
                    }
                    ...
                    .responsive-table-data[data-label]:before {
                        ...
                        font-weight: bold;
                        display: block;
                        /* Make the label appear above the input */
                        margin-bottom: 5px;
                    ...
                    .responsive-table-data input[type="text"] {
                        width: 100% !important;
                        min-height: 40px;
                        /* Keep consistent with desktop input height */
                        box-sizing: border-box;
