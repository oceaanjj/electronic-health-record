...
<body class="login-page">
                ...
                <form action="{{ route('login.authenticate') }}" method="POST" id="loginForm" novalidate>
                    ...
                    <div class="input-group">
                        ...
                        <input
                            ...
                            class="h-[50px] {{ $errors->has('username') ? 'input-error' : '' }}"
                            value="{{ old('username') }}"
                            autocomplete="username"
                        >
                     
                        <div class="validation-error {{ $errors->has('username') ? 'visible' : '' }}" id="username-error">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                                <circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/>
                            </svg>
                            <span id="username-error-text">
                                @error('username') {{ $message }} @else The username field is required. @enderror
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <div class="password-wrapper">
                            <input
                                ...
                                class="h-[50px] {{ $errors->has('password') ? 'input-error' : '' }}"
                                autocomplete="current-password"
                            >
                            <span id="togglePassword" class="toggle-password" onclick="togglePassword()" role="button" aria-label="Toggle password visibility">
                                <i data-lucide="eye-off" class="eye-icon"></i>
                            </span>
                        </div>
                     
                        <div class="validation-error {{ $errors->has('password') ? 'visible' : '' }}" id="password-error">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                                <circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/>
                            </svg>
                            <span id="password-error-text">
                                @error('password') {{ $message }} @else The password field is required. @enderror
                            </span>
                        </div>
                    </div>
    ...
    <script>
        ...
        const eyeOffPath = 'M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24';
