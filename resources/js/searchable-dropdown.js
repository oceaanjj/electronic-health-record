const initSearchableDropdown = () => {
    ...
    const disableForm = (isDisabled) => {
        ...
        let formElement = formContentContainer ? formContentContainer.querySelector('form.cdss-form') : null;
        ...
        const formFieldset = formContentContainer ? formContentContainer.querySelector('fieldset') : null;
        ...
        if (formElement) {
            ...
            if (isDisabled) {
                if (!overlay) {
                    ...
                    overlay.className = 'trigger-patient-alert absolute inset-0 z-50 bg-transparent cursor-not-allowed';
    ...
    const clearFormInputs = () => {
        ...
        if (formContentContainer) {
            const inputs = formContentContainer.querySelectorAll('input, textarea, textarea.notepad-lines');
            ...
            const diagnosticPanels = formContentContainer.querySelectorAll('.diagnostic-panel');
