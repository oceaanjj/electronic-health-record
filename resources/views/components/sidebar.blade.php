    ...
    <ul class="mt-[140px] text-dark-green text-[13px] font-creato-black pr-[10px] pl-[10px]">
        ...
        <li>
            <a href="{{ route('patients.index') }}"
                class="group flex items-center gap-3 pl-4 pb-2 pt-2 
                    ...
                    <span class="{{ request()->routeIs('patients.index') ? 'text-white font-bold' : 'group-hover:font-bold' }}">Demographic Profile</span>
            </a> 
        </li>
        ...
        <li>    
            <a href="{{ route('medical-history') }}"
                class="group flex items-center gap-3 pl-4 pb-2 pt-2 
                    ...
                    <span class="{{ request()->routeIs('medical-history') ? 'text-white font-bold' : 'group-hover:font-bold' }}">Medical History</span>
            </a>
        </li>
        ...
        <li>
            ...
            class="group flex items-center gap-3 pl-4 pb-2 pt-2 
                    ...
                    <span class="{{ request()->routeIs('physical-exam.index') ? 'text-white font-bold' : 'group-hover:font-bold' }}">Physical Exam</span>
            </a>
        </li>
        ...
        <li>
            <a href="{{ route('vital-signs.show') }}"
             ...
             class="group flex items-center gap-3 pl-4 pb-2 pt-2 
                    ...
                    <span class="{{ request()->routeIs('vital-signs.show') ? 'text-white font-bold' : 'group-hover:font-bold' }}">Vital Signs</span>
            </a>
        </li>
        ...
        <li>
            <a href="{{ route('io.show') }}"
             class="group flex items-center gap-3 pl-4 pb-2 pt-2 
                    ...
                    <span class="{{ request()->routeIs('io.show') ? 'text-white font-bold' : 'group-hover:font-bold' }}">Intake and Output</span>
            </a>
        </li>
        ...
        <li>
            <a href="{{ route('adl.show') }}"
                 class="group flex items-center gap-3 pl-4 pb-2 pt-2 
                    ...
                    <span class="{{ request()->routeIs('adl.show') ? 'text-white font-bold' : 'group-hover:font-bold' }}">Activities of Daily Living</span>
            </a>
        </li>
        ...
        <li>
            <a href="{{ route('lab-values.index') }}"
             class="group flex items-center gap-3 pl-5 pb-2 pt-2 
                    ...
                    <span class="{{ request()->routeIs('lab-values.index') ? 'text-white font-bold' : 'group-hover:font-bold' }}">Lab Values</span>
            </a>
        </li>
        ...
        <li>
            <a href="{{ route('medication-administration') }}"
                 class="group flex items-center gap-3 pl-5 pb-2 pt-2 
                    ...
                    <span class="{{ request()->routeIs('medication-administration') ? 'text-white font-bold' : 'group-hover:font-bold' }}">Medication Administration</span>
            </a>
        </li>
        ...
        <li>
            <a href="{{ route('medication-reconciliation') }}"
                    ...
                    <span class="{{ request()->routeIs('medication-reconciliation') ? 'text-white font-bold' : 'group-hover:font-bold' }}">Medication Reconciliation</span>
            </a>
        </li>
