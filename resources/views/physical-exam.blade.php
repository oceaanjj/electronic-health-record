...
@section('content')
    ...
    {{--
    THIS IS THE LINE TO EDIT for other forms
    Add class="cdss-form" and data-analyze-url="..."
    --}}
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="alert-box" data-alert-for="general_appearance">
                        {{-- Server-side alerts (on initial load/submit) --}}
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="skin_condition" class="notepad-lines cdss-input" data-field-name="skin_condition"
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="oral_condition" class="notepad-lines cdss-input" data-field-name="oral_condition"
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="cardiovascular" class="notepad-lines cdss-input" data-field-name="cardiovascular"
