...
@section('content')
    ...
    {{-- Main Form --}}
    <form
        action="{{ route('nursing-diagnosis.storeDiagnosis', ['component' => $component, 'id' => $intakeAndOutputId]) }}"
        method="POST"
        ...
        <fieldset>
            <div class="mx-auto mt-2 w-[70%]">
                ...
                @if ($component === 'intake-and-output')
                    @php
                        $alert = session('intake-and-output-alerts')['diagnosis'] ?? null;
...
{{ old('diagnosis', $diagnosis->diagnosis ?? '') }}</textarea
            ...
            <div class="mx-auto mt-8 mb-12 flex w-[70%] items-center justify-between">
                <div class="flex flex-col items-start">
                    <a href="{{ route('io.show') }}" class="button-default text-center">GO BACK</a>
                </div>
