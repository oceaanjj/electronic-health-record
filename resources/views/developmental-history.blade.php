...
@section('content')
        ...
        <form action="{{ route('medical.store') }}" method="POST">
            ...
            <center>
                ...
                <table class="mb-1.5 w-[72%] border-separate border-spacing-0">
                    ...
                    <tr>
                        ...
                        <th class="bg-yellow-light text-brown text-[13px] border-l-2 border-r-2 border-t-2 border-line-brown rounded-tr-lg">FINDINGS</th>
                    </tr>
                    
                    <tr>
                        <td class="rounded-br-lg">
                            <textarea class="notepad-lines h-[100px]" name="gross_motor" placeholder="Type here...">{{ $developmentalHistory->gross_motor ?? '' }}</textarea>
                        </td>
                    </tr>
                </table>
            ...
            <table class="mb-1.5 w-[72%] border-separate border-spacing-0">
                ...
                <tr>
                    <td class="rounded-br-lg">
                        <textarea class="notepad-lines h-[100px]" name="fine_motor" placeholder="Type here...">{{ $developmentalHistory->fine_motor ?? '' }}</textarea>
                    </td>
                </tr>
            </table>
            ...
            <table class="mb-1.5 w-[72%] border-separate border-spacing-0">
                ...
                <tr>
                    <td class="rounded-br-lg">
                        <textarea class="notepad-lines h-[100px]" name="language" placeholder="Type here...">{{ $developmentalHistory->language ?? '' }}</textarea>
                    </td>
                </tr>
            </table>
            ...
            <table class="mb-1.5 w-[72%] border-separate border-spacing-0">
                ...
                <tr>
                    <td class="rounded-br-lg">
                        <textarea class="notepad-lines h-[100px]" name="cognitive" placeholder="Type here...">{{ $developmentalHistory->cognitive ?? '' }}</textarea>
                    </td>
                </tr>
            </table>
            ...
            <table class="mb-1.5 w-[72%] border-separate border-spacing-0">
                ...
                <tr>
                    <td class="rounded-br-lg">
                        <textarea class="notepad-lines h-[100px]" name="social">{{ $developmentalHistory->social ?? '' }}</textarea>
                    </td>
                </tr>
            </table>
            </center>
