...
<html>
    ...
    <body>
        @include(
            'doctor.reports.partials._patient_demographics',
            [
                'patient' => $patient,
            ]
        )
        ...
        @include(
            'doctor.reports.partials._vital_signs',
            [
                'vitals' => $vitals,
            ]
        )
        ...
        @include(
            'doctor.reports.partials._lab_values',
            [
                'labValues' => $labValues,
            ]
        )
        ...
        @include(
            'doctor.reports.partials._diagnostics',
            [
        ...
        @include(
            'doctor.reports.partials._ivs_and_lines',
            [
