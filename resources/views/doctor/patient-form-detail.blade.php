                ...
                <div class="flex items-center gap-3 min-w-0">
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="text-sm font-alte-regular text-gray-500 mt-0.5 truncate">
                            Patient: <a href="{{ route('doctor.patient-details', $patient->patient_id) }}?from=form-detail&type={{ $type }}" class="font-alte text-gray-700 hover:underline hover:text-green-700 transition-colors">{{ $patient->name }}</a>
