...
@section('content')
    ...
    @php
        ...
        $currentStep = 4; // Step 4 (Evaluation page)
    @endphp
        ...
        <fieldset>
                        ...
                        <div class="banner-content">
                            ...
                            <div class="banner-text">
                                ...
                                <div class="banner-subtitle">
                                    Type more details in the evaluation field to receive clinical recommendations
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="w-full overflow-hidden rounded-[15px] shadow-md">
                    ...
                    <div class="relative bg-beige">
                        <textarea
                            id="evaluation"
                            name="evaluation"
                            class="notepad-lines font-typewriter cdss-input evaluation-textarea w-full rounded-b-lg shadow-sm"
            ...
            <div class="mx-auto mt-8 mb-12 flex w-[70%] items-center justify-between">
                <div class="flex flex-col items-start">
                    <a href="{{ route('nursing-diagnosis.showIntervention', ['component' => $component, 'nursingDiagnosisId' => $diagnosis->id]) }}" class="button-default text-center">
                        GO BACK
                    </a>
                </div>
...
@push('scripts')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            textarea.addEventListener('input', function() {
                ...
                saveTimeout = setTimeout(function() {
                    ...
                    if (patientId && component) {
                        localStorage.setItem(`evaluation_draft_${component}_${patientId}`, textarea.value);
                    }
                }, 1500);
            });
            ...
            const component = '{{ $component }}';
            if (patientId && component) {
                const draft = localStorage.getItem(`evaluation_draft_${component}_${patientId}`);
            ...
            document.querySelector('form').addEventListener('submit', function() {
                if (patientId && component) {
                    localStorage.removeItem(`evaluation_draft_${component}_${patientId}`);
                }
            });
