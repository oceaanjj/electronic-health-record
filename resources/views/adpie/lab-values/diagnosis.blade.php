...
@section('content')
    ...
    {{-- Main Form --}}
    <form
        action="{{ route('nursing-diagnosis.storeDiagnosis', ['component' => $component, 'id' => $labValues->id]) }}"
        method="POST"
...
{{ old('diagnosis', $diagnosis->diagnosis ?? '') }}</textarea
            ...
            <div class="mx-auto mt-8 mb-12 flex w-[70%] items-center justify-between">
                <div class="flex flex-col items-start">
                    <a href="{{ route('lab-values.index') }}" class="button-default text-center">GO BACK</a>
                </div>
...
@push('scripts')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            textarea.addEventListener('input', function () {
                ...
                saveTimeout = setTimeout(function () {
                    ...
                    if (patientId && component) {
                        localStorage.setItem(`diagnosis_draft_${component}_${patientId}`, textarea.value);
                    }
                }, 1500);
            });
            ...
            const component = '{{ $component }}';
            if (patientId && component) {
                const draft = localStorage.getItem(`diagnosis_draft_${component}_${patientId}`);
            ...
            document.querySelector('form').addEventListener('submit', function () {
                if (patientId && component) {
                    localStorage.removeItem(`diagnosis_draft_${component}_${patientId}`);
                }
            });
