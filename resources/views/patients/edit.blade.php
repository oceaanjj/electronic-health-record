                ...
                <div class="bg-beige p-6 rounded-b-lg shadow-md mb-8">
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6">
                            <label for="chief_complaints" class="block mb-2 font-bold text-dark-green">Chief of
                                Complaints</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="col-span-1">
                            <label for="contact_relationship"
                                class="block mb-2 font-bold text-dark-green">Relationship</label>
                        ...
                        {{-- Contact Number --}}
                        <div class="col-span-1">
                            <label for="contact_number" class="block mb-2 font-bold text-dark-green">Contact
                                Number</label>
