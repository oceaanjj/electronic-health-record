            ...
            <div class="flex flex-col sm:flex-row justify-center items-center gap-5">
                ...
                <div class="searchable-dropdown relative w-full sm:w-[350px]"
                    ...
                    <div id="patient-loading" class="hidden absolute right-4 top-1/2 -translate-y-1/2">
                        <svg class="w-5 h-5 text-dark-green animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24">
                    ...
                    <div id="patient_options_container"
                        ...
                        @foreach ($patients as $patient)
                            <div class="option px-4 py-2 hover:bg-green-50 cursor-pointer transition-colors duration-200"
