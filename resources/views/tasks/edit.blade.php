            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="category" 
                        ...
                        <option value="clinical" {{ old('category', $task->category) === 'clinical' ? 'selected' : '' }}>Clinical</option>
                        <option value="administrative" {{ old('category', $task->category) === 'administrative' ? 'selected' : '' }}>Administrative</option>
                        <option value="technical" {{ old('category', $task->category) === 'technical' ? 'selected' : '' }}>Technical</option>
                ...
                <div>
                    ...
                    <select name="patient_id" 
                        ...
                        @foreach($patients as $patient)
                            <option value="{{ $patient->patient_id }}" {{ old('patient_id', $task->patient_id) == $patient->patient_id ? 'selected' : '' }}>
                                {{ $patient->name }}
                            </option>
                        @endforeach
                    </select>
