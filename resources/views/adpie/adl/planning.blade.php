...
@section('content')
    ...
    @php
        ...
        $currentStep = 2; // Step 2 (Planning page)
    @endphp
    ...
    {{-- Main Form --}}
    <form
        action="{{ route('nursing-diagnosis.storePlanning', ['component' => $component, 'nursingDiagnosisId' => $diagnosis->id]) }}"
        method="POST"
        ...
        <fieldset>
            <div class="mx-auto mt-2 w-[70%]">
                ...
                @if ($component === 'intake-and-output')
                    @php
                        $alert = session('intake-and-output-alerts')['planning'] ?? null;
                        ...
                        <div class="banner-content">
                            ...
                            <div class="banner-text">
                                ...
                                <div class="banner-subtitle">
                                    Type more details in the planning field to receive clinical recommendations
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="w-full overflow-hidden rounded-[15px] shadow-md">
                    ...
                    <div class="relative bg-beige">
                        <textarea
                            id="planning"
                            name="planning"
                            class="notepad-lines font-typewriter cdss-input planning-textarea w-full rounded-b-lg shadow-sm"
                            data-field-name="planning"
                            style="border-top: none"
                            placeholder="Enter planning (e.g., Goals, Objectives)..."
                            maxlength="2000"
            ...
            <div class="mx-auto mt-8 mb-12 flex w-[70%] items-center justify-between">
                <div class="flex flex-col items-start">
                    <a href="{{ route('nursing-diagnosis.start', ['component' => $component, 'id' => $diagnosis->intake_and_output_id]) }}" class="button-default text-center">
                        GO BACK
                    </a>
                </div>
...
@push('scripts')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const textarea = document.getElementById('planning');
            ...
            textarea.addEventListener('input', function() {
                ...
                saveTimeout = setTimeout(function() {
                    ...
                    if (patientId && component) {
                        localStorage.setItem(`planning_draft_${component}_${patientId}`, textarea.value);
                    }
                }, 1500);
            });
            ...
            const component = '{{ $component }}';
            if (patientId && component) {
                const draft = localStorage.getItem(`planning_draft_${component}_${patientId}`);
            ...
            document.querySelector('form').addEventListener('submit', function() {
                if (patientId && component) {
                    localStorage.removeItem(`planning_draft_${component}_${patientId}`);
                }
            });
