...
<head>
  ...
  <style>
    ...
    .swal-glass-confirm {
      ...
      box-shadow: 0 8px 20px rgba(41, 165, 57, 0.25) !important;
      transition: all 0.3s ease !important;
    }

    .swal-glass-confirm:hover {
      transform: translateY(-2px) !important;
      box-shadow: 0 10px 25px rgba(41, 165, 57, 0.35) !important;
    }

    .swal-glass-icon {
      border-color: #29A539 !important;
    }

    .swal2-icon.swal2-success [class^='swal2-success-line'] {
      background-color: #29A539 !important;
    }

    .swal2-icon.swal2-success .swal2-success-ring {
      border: .25em solid rgba(41, 165, 57, .3) !important;
    }
...
<body>
  ...
  <nav>
    <div class="nav-brand">
      <div class="nav-logo">
        <img src="{{ asset('img/ehr-logo.png') }}" alt="Logo"
    ...
    <div class="nav-actions">
      ...
      <a href="{{ asset('mobile-app/ehr-release.apk') }}" download onclick="showDownloadAlert()">
    ...
    <div class="feat-cards">
      <div class="feat-card reveal">
        <div class="feat-icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none"
            stroke="#c8a040" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="feat-card-text">
          ...
          <p>Real-time alerts for every input</p>
        </div>
      </div>
      ...
      <div class="feat-card reveal">
        ...
        <div class="feat-card-text">
          ...
          <p>Helping you to make decisions</p>
        </div>
      </div>
      ...
      <div class="feat-card reveal">
        ...
        <div class="feat-card-text">
          <h4>PDF</h4>
          <p>Easily generate pdf record</p>
        </div>
      </div>
    </div>
  ...
  <script>
    function showDownloadAlert() {
      Swal.fire({
        ...
        html: '<div class="swal-glass-content">The .apk file is downloading. Please check your notifications.<br><br>For Android users, you may need to allow installations from <b>"Unknown Sources"</b> in your settings.</div>',
        icon: 'success',
